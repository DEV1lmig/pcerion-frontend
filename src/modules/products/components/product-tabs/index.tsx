    ...
    <Tab.Panel className="text-small-regular py-8">
      <div className="grid grid-cols-1 gap-y-8">
        <div className="flex items-start gap-x-2">
          <FastDelivery />
          <div>
            <span className="font-semibold">Delivery rápido</span>
        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
            ¿El ajuste no es del todo correcto? No hay problema- we&apos;cambiaremos tu
        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
            Simplemente devuelva su producto y we&apos;Le reembolsaremos su dinero. No
              preguntas hechas – we&apos;Haremos todo lo posible para asegurarnos de que regreses.
              es sin complicaciones.
            </p>
          </div>
        </div>
      </div>
