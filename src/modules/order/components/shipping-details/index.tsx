...
const ShippingDetails = ({
  ...
  return (
    <div className="text-base-regular">
      <h2 className="text-base-semi">Entrega</h2>
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700">Dirección</h3>
      ...
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700">Método de entrega</h3>
        <div>
